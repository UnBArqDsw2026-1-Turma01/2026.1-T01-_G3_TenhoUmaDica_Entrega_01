...
| **3** | **Decision (Decidir)**     | Momento de convergência onde ocorreu a seleção das melhores ideias e melhores _Rich Picture_. A partir dessa escolha, criamos um outro _Rich Picture_ concatecnando essas ideias e desenhamos o _storyboarding_ que serviu como guia para o fluxo de telas. Técnicas como de _5W2H_, _Diagrama de Causa e Efeito (ishikawa)_, _Estimativas_ e _Glossário_ também foram utilizadas nessa fase. |
...
|   ![Rich Picture João Reis](../assets/richPictures/RP_joaoReis.png) <br> <font size="2"><p style="text-align: center">Fonte: [João Reis](https://github.com/Joaolramos), 2026.</p></font>   |          ![Rich Picture Marcos](../assets/richPictures/RP_marcos.png) <br> <font size="2"><p style="text-align: center">Fonte: [Marcos](https://github.com/marcoslbz), 2026.</p></font>           |       ![Rich Picture Renan](../assets/richPictures/RP_renan.png) <br> <font size="2"><p style="text-align: center">Fonte: [Renan](https://github.com/rsribeiro1), 2026.</p></font>       |        ![Rich Picture Gabriel Augusto](../assets/richPictures/RP_gabriel_augusto.png) <br> <font size="2"><p style="text-align: center">Fonte: [Gabriel Augusto](https://github.com/gabrielaugusto23), 2026.</p></font>       |
...
## Consolidação da Estimativa

- [Ata de Reunião - 05/04/2026](/Atas/2026-04-05.md)

O vídeo da consolidação quantitativa das estimativas está disponível no Youtube:
...
| 1.6    | Retirando duplicidade de participantes. | [João Reis](https://github.com/Joaolramos)     | 06/04/2026 |
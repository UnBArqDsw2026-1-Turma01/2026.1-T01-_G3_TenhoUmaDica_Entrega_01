...
<font size="2"><p style="text-align: center">Fonte: Angélica, Brenda, Diogo, [Felipe Rodrigues](https://github.com/felipeJRdev), Gabriel Augusto, Gabriel Maciel, João Gabriel, João Reis, Marcos e Renan, 2026.</p></font>

## Sketch

### Rich Picture

Modelagem de ideias pouco formal que utiliza rascunhos e textos curtos para expressar as necessidades e as interações do sistema. Cada membro da equipe utilizou a técnica para propor sua visão do modelo de forma rápida.
...
Ferramenta visual que mapeia um problema central (o efeito) e suas raízes estruturais (as causas) divididas em categorias. Auxilia na compreensão do cenário atual para a proposição de ações corretivas no ecossistema do campus.

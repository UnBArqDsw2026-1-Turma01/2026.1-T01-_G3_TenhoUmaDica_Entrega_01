...
### Quadro do Fluxo de Cadastro de Avaliações

Este fluxograma detalha o processo de cadastro de novas avaliações, estabelecendo as etapas até a conclusão da avaliação feita pelo usuário.

![Modelagem BPMN - Fluxo de Cadastro de Avaliações](../assets/bpmn/fluxo%20de%20avaliações%20BPMN.png)

<br> <font size="2"><p style="text-align: center">Fonte: [Gabriel Augusto](https://github.com/https://github.com/gabrielaugusto23), 2026.</p></font>

### Quadro do Fluxo de Login (Versão 1)

![Modelagem BPMN - Fluxo de Login de Usuário (Versão 1)](../assets/bpmn/Fluxo_de_Login_BPMN.png)

<br> <font size="2"><p style="text-align: center">Fonte: [Renan Ribeiro](https://github.com/https://github.com/rsribeiro1),  2026.</p></font>

### Quadro do Fluxo de Login (Versão 2)
![Modelagem BPMN - Fluxo de Login de Usuário (Versão 2)](../assets/bpmn/fluxo_login2.png)

<br> <font size="2"><p style="text-align: center">Fonte: [João Reis](https://github.com/https://github.com/rsribeiro1),  2026.</p></font>
...
2.4 | Adição da V1 do Fluxo de Login de Usuários| [Renan Ribeiro](https://github.com/rsribeiro1) | 06/04/2026 |
2.5 | Adição da V2 do Fluxo de Login de Usuários | [João Reis](https://github.com/Joaolramos) | 06/04/2026 |

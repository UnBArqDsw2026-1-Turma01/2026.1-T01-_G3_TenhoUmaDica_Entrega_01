...
<font size="3"><p style="text-align: center">Imagem 2: Fluxo Scrum</p></font>
...
<font size="3"><p style="text-align: center">Imagem 3: Fluxo Kanban</p></font>
...
<font size="3"><p style="text-align: center">Imagem 4: Fluxo Funcionalidades</p></font>
...
<font size="3"><p style="text-align: center">Imagem 5: Fluxo Ciclo de Vida da Dica</p></font>
...
2.0 | Adição de Quadro com as principais Funcionalidades dos Usuários | [Brenda Silva](https://github.com/Brwnds)
2.1 | Adição de Mapeamento do Domínio: Ciclo de Vida da Dica | [Angélica Campos](https://github.com/angelicaccampos)
2.2 | Adição de Fluxo de Cadastro de Usuário |      [Gabriel Maciel](https://github.com/GabrielMacielBR)

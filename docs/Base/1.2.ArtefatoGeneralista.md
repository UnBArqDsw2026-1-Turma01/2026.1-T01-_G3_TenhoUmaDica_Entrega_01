...
<p>Um fórum web para alunos da UnB, focado em discussões de disciplinas, compartilhamento de materiais de estudo, avaliações de professores e dicas gerais da comunidade universitária, com importação de dados base do SIGAA.</p>
</details>

<details>
  <summary><b>Why (Por que)?</b></summary>
  <p>Para centralizar a comunicação discente e organizar materiais de estudo evitando a descentralização dos conteúdos e suprindo a necessidade que o SIGAA deveria resolver, fornecendo feedback honesto e prévio sobre a didática e o perfil de cobrança dos professores, além de permitir acesso à dicas pertinentes para jornada acadêmica do estudante.</p>
</details>
...
<details>
  ...
  <p>A aplicação web será um site, disponível para qualquer dispositivo com acesso a um navegador.</p>
</details>
...
<font size="2"><p style="text-align: center">Fonte: [Diogo](https://github.com/Diogo-Olivv) e [João Reis](https://github.com/Joaolramos), 2026.</p></font>
...
| 1.3    | Criação do documento de glossário e definição dos termos iniciais.| [Angélica](https://github.com/angelicaccampos)  | 05/04/2026 |
| 1.4    | Elaboração das estimativas de projeto e cronograma de sprints.| [Angélica](https://github.com/angelicaccampos)  | 05/04/2026 |
| 1.5    | Adição de informações ao 5W2H| [João Reis](https://github.com/Joaolramos)  | 06/04/2026 |
